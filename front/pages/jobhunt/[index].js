...
//   console.log("id", window.location.href.substring(30));
...
//   const [page, setPage] = React.useState(router.query.id);
//   //   const [page, setPage] = React.useState(router.query.search);
//   // const [page, setPage] = React.useState(router.query.index);
//   // const [page, setPage] = React.useState(window.location.href.substring(30));
