...
async function fetchProjects(page = 0) {
  ...
  console.log("함수1", window.location.href[(5, 2)]);
  console.log("함수2", window.location.href.substring(22));
  console.log("함수3", window.location.href);
  console.log("함수4", URLSearch);
...
const IndexPage = () => {
  ...
  // React.useEffect(() => {
  //   if (data?.id) {
  //     queryClient.prefetchQuery(["prosts", page + 1], () =>
    ...
    <div style={{ background: "#e87777" }}>
      ...
      <MainDiv>
        ...
        <div>
          ...
          <div>Current Page: {router.query.index}</div>
          <button
